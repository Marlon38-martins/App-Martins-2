...
import { ArrowLeft, Tag, PlusCircle, Loader2, AlertCircle, ShieldAlert, Download, RefreshCw } from 'lucide-react';
        ...
        <Card className="shadow-md">
          <CardHeader className="p-3">
            <CardTitle className="flex items-center text-base text-primary md:text-lg">
              ...
              QR Code da Oferta: {createdOfferDetails.title}
            </CardTitle>
            <CardDescription className="text-xs md:text-sm">
              Este QR Code pode ser usado pelos clientes para resgatar a oferta.
            </CardDescription>
          </CardHeader>
          <CardContent className="p-3 text-center">
            ...
            >
              <a href={`https://placehold.co/200x200.png?text=QR+${createdOfferDetails.id.substring(0, 12)}`} download={`QR_Code_Normal_${createdOfferDetails.title.replace(/\s+/g, '_')}.png`}>
