  ...
  return (
    <div className="p-4 md:p-6 space-y-8">
      ...
      <section className="mb-6">
        ...
        <p className="text-muted-foreground">Acompanhe as métricas do seu estabelecimento no Guia Mais.</p>
      </section>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card className="shadow-lg">
          <CardHeader>
            <CardTitle className="flex items-center text-lg text-accent"><Eye className="mr-2 h-5 w-5"/> Visualizações da Página</CardTitle>
            <CardDescription>Quantas vezes seu estabelecimento foi visto.</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="shadow-lg">
          <CardHeader>
            <CardTitle className="flex items-center text-lg text-accent"><ShoppingCart className="mr-2 h-5 w-5"/> Resgates de Ofertas</CardTitle>
            <CardDescription>Número de ofertas Guia Mais utilizadas.</CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <Card className="shadow-lg">
        <CardHeader>
          <CardTitle className="flex items-center text-lg text-accent"><MessageSquare className="mr-2 h-5 w-5"/> Feedback de Clientes</CardTitle>
          <CardDescription>Avaliações e comentários (funcionalidade futura).</CardDescription>
        </CardHeader>
        <CardContent>
