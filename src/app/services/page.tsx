      ...
      {!isLoading && !error && filteredCategories.length === 0 && (
        <div className="mt-12 flex flex-col items-center justify-center text-center">
          ...
          <h3 className="text-xl font-semibold text-foreground">
            {allCategories.length > 0 && categorySearchTerm ? 'Nenhuma categoria encontrada para "' + categorySearchTerm + '"' : 'Nenhuma categoria de serviço encontrada'}
          </h3>
          <p className="text-muted-foreground">
            {allCategories.length > 0 && categorySearchTerm ? 'Tente um termo de busca diferente.' : 'Parece que ainda não há serviços cadastrados.'}
          </p>
        </div>
      )}
